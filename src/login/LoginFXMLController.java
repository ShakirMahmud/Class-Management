...
import static login.VerificationFXMLController.ac;
import static login.VerificationFXMLController.mainWindow;
...
public class LoginFXMLController implements Initializable {
    ...
    @FXML
    private void signUpButtonPushed(ActionEvent event) throws IOException, InterruptedException, SQLException
    {
